...
class Governo extends ModeloFramework
{
    ...
    public function salvarGovernoDiscipulo()
    {
        //abrir conexao com o banco
        $pdo = new \PDO(DSN, USER, PASSWD);
        //cria sql
        $sql = "INSERT INTO GovernoTemDiscipulo ( ministerioId, discipuloId, funcaoId )
            VALUES (?,?,?)";
    ...
    public function listarTodos()
    {
        ...
        while ($obj = $stm->fetchObject('\Governo\Modelo\Governo')) {
            $resposta[$obj->id] = $obj;
        }
    ...
    public function listarUm()
    {
        ...
        /* $sql = 'SELECT * FROM Governos '; */
        $sql = 'SELECT * FROM Governos WHERE id = ?';
        ...
        /* var_dump($stm->fetchObject('\Governo\Modelo\Governo')); */
        /* var_dump ( $stm->errorInfo());die; */

        return $stm->fetchObject('\Governo\Modelo\Governo');
    }
    ...
    public function excluir()
    {
        try {
            ...
            $sql = 'DELETE FROM Governo WHERE id = ?';
    ...
    public function lideresRede()
    {
        ...
        //while ($obj = $stm->fetchObject('\Rede\Modelo\Governo')) {
            //$resposta[$obj->id] = $obj;
        //}
