        ...
        <section>
            ...
            <?php if (isset($mensagem)) : ?>
                ...
                <?php endif ; ?>
                    ...
                    <form action = "/discipulo/novoAnonimo" method = "post"  class = "form-horizontal">
                <fieldset>
                    <legend>Criar Discipulo</legend>
                        ...
                        <div class = "controls" >
                        <input class = "span4" name = "endereco"  value = "<?php echo isset($post['endereco']) ? $post['endereco'] : '' ?>" placeholder = "Ex: Quadra 300 Conjunto 08 casa 11 " required >
