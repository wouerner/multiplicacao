...
CREATE  TABLE IF NOT EXISTS `multiplicacao`.`Oferta` (
  `id` INT(11) NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `multiplicacao`.`permissions` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT ,
  `permKey` VARCHAR(45) NULL DEFAULT NULL ,
  `permName` VARCHAR(45) NULL DEFAULT NULL ,
  PRIMARY KEY (`ID`) )
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci;

CREATE  TABLE IF NOT EXISTS `multiplicacao`.`roles` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT ,
...
CREATE  TABLE IF NOT EXISTS `multiplicacao`.`user_perm` (
  ...
  `permID` INT(11) NULL DEFAULT NULL ,
  `value` TINYINT(4) NULL DEFAULT NULL ,
  `addDate` DATETIME NULL DEFAULT NULL ,
  PRIMARY KEY (`ID`) ,
